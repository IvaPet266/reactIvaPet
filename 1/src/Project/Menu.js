...
export default function Menu( props ) {
  ...
  return (
    <div id="menu" style={{ background: "#DBC1FF", padding: ""}}>
      ...
      // TODO доделать функцию onClick, чтобы hover становился постоянным и наоборот
      <SVGButton id="search" d="M55.25 55.25L42.5625 42.5625M49.4167 26.0833C49.4167 38.97 38.97 49.4167 26.0833 49.4167C13.1967 49.4167 2.75 38.97 2.75 26.0833C2.75 13.1967 13.1967 2.75 26.0833 2.75C38.97 2.75 49.4167 13.1967 49.4167 26.0833Z"/>
